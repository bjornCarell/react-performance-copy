...
Main take away for now: We can take some JavaScript that is expensive to run
and put it on a separate thread so that our main thread is freed up to display
